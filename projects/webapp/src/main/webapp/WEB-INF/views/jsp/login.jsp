...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/frameworks/adminLTE/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="${pageContext.request.contextPath}/assets/frameworks/adminLTE/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
